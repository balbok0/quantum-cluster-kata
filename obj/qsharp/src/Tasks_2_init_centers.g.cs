...
namespace Final_Project
{
    public class quantum_initialization_centers_random : Operation<(Int64,Int64), QArray<Int64>>, ICallable
    {
        ...
        {
            var (n,k) = __in__;
#line 7 "/Users/john/Desktop/CSE490Q/quantum-cluster-kata/Tasks_2_init_centers.qs"
            var centers = new QArray<Int64>(k);
#line 8 "/Users/john/Desktop/CSE490Q/quantum-cluster-kata/Tasks_2_init_centers.qs"
            foreach (var i in new Range(0L, (k - 1L)))
#line hidden
            {
#line 9 "/Users/john/Desktop/CSE490Q/quantum-cluster-kata/Tasks_2_init_centers.qs"
                centers[k] = MicrosoftQuantumCanonRandomInt.Apply(n);
            }

#line 11 "/Users/john/Desktop/CSE490Q/quantum-cluster-kata/Tasks_2_init_centers.qs"
            return centers;
        }
    ...
    public class quantum_initialization_centers_smart : Operation<(Int64,Int64,QArray<Qubit>), QArray<Int64>>, ICallable
    {
        ...
        {
            var (n,k,data) = __in__;
#line 16 "/Users/john/Desktop/CSE490Q/quantum-cluster-kata/Tasks_2_init_centers.qs"
            var centers = new QArray<Int64>(k);
#line 18 "/Users/john/Desktop/CSE490Q/quantum-cluster-kata/Tasks_2_init_centers.qs"
            centers[0L] = MicrosoftQuantumCanonRandomInt.Apply(n);
#line 20 "/Users/john/Desktop/CSE490Q/quantum-cluster-kata/Tasks_2_init_centers.qs"
            foreach (var i in new Range(2L, (k - 1L)))
#line hidden
            {
            }

#line 24 "/Users/john/Desktop/CSE490Q/quantum-cluster-kata/Tasks_2_init_centers.qs"
            return centers;
        }
